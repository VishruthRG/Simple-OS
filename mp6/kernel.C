...
int main() {
    ...
    InterruptHandler::register_handler(14,(InterruptHandler*)SYSTEM_DISK); // registering interrupt 14 with interrupt handler to avoid seeing interrupt message on console
    /* -- ENABLE INTERRUPTS -- */
